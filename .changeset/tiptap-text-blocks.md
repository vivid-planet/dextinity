...
createTipTapRichTextBlock({
    textBlocks: [
        { name: "paragraph", label: "Paragraph", tag: "p", styles: ["copy100", "copy200"], defaultStyle: "copy200" },
        { name: "heading-1", label: "Heading 1", tag: "h1", styles: ["headline300", "headline400"], defaultStyle: "headline300" },
        { name: "heading-2", label: "Heading 2", tag: "h2", styles: ["headline300", "headline400"], defaultStyle: "headline400" },
    ],
    textBlockStyles: [
...
- A text block style's `appliesTo` → the `styles` of the text blocks that offer it. Lists take their styles the same way: `orderedList`/`unorderedList` accept `{ styles, defaultStyle }` instead of `true`.
