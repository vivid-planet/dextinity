...
export { PageTreeNodeCategory, PageTreeNodeInterface, PageTreeNodeVisibility } from "./page-tree/types";
...
export { ScopeInterface } from "./user-permissions/interfaces/scope.interface";
