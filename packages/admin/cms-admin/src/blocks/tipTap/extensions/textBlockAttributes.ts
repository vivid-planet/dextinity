/**
 * The attributes that identify a node's text block and the style applied to it. They are rendered
 * to (and parsed from) HTML, so they survive the content translation's HTML round trip.
 */
export const textBlockAttributes = {
    textBlock: {
        default: null,
