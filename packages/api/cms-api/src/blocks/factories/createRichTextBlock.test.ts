...
describe("createRichTextBlock", () => {
    ...
    it("should include the link block in the block meta", () => {
        const expectedFields = [{ name: "draftContent", kind: BlockMetaFieldKind.RichTextBlock, link: LinkBlock, nullable: false }];
    ...
    it("should include the link block name in the generated block meta", () => {
        ...
        expect(blockMeta?.fields).toEqual([{ name: "draftContent", kind: "RichTextBlock", link: "RichTextMetaTestLink", nullable: false }]);
    });
});
