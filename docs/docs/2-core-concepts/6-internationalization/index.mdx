...
import dextinity_demo_messages_de from "../lang-compiled/dextinity-demo-lang/de.json";
import dextinity_demo_messages_en from "../lang-compiled/dextinity-demo-lang/en.json";
...
export const getMessages = (): ResolvedIntlConfig["messages"] => {
    ...
    return {
        ...dextinityMessages["en"],
        ...dextinityDemoMessages["en"],
    };
};
```
...
Dextinity provides a set of commonly used messages exported from `@dextinity/admin`. They are already translated and can be used inside applications.
