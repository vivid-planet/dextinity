...
/**
 * Applies a text block's (or a list's) `defaultStyle` to every paragraph/heading that carries no
 * style yet. The editor creates such nodes in several ways that don't go through the toolbar -
 * pressing Enter at the end of a heading, the paragraph/heading keyboard shortcuts, pasting - so
 * filling the style in here keeps them all consistent without reimplementing each of those.
 *
                ...
                new Plugin({
                    ...
                    appendTransaction(transactions, _, newState) {
                        ...
                        newState.doc.descendants((node, pos) => {
                            ...
                            if (!isTextBlock || node.attrs.textBlockStyle != null) {
                                return;
                            }
                            ...
                            const styledNode: TipTapResolvedStyledNode | undefined =
                                ...
                                findTextBlock({ name: node.attrs.textBlock, tag, textBlocks });
