...
const RichTextBlock = createRichTextBlock({ link: LinkBlock }, "UsedBlocksTestRichText");
...
describe("getUsedBlocks", () => {
    ...
    it("returns the link block of a rich text block", () => {
        const usedBlocks = getUsedBlocks([RichTextBlock]);
