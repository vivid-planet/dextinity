...
The field kind of the `draftContent` field changes from `Json` to `RichTextBlock`, which affects projects that read `block-meta.json` themselves. See the migration guide for instructions on how to upgrade your project.
