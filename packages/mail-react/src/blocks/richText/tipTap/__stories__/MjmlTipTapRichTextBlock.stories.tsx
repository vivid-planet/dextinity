...
export const WithTextBlockStyles: Story = {
    ...
    render: () => {
        ...
        return (
            <MjmlSection indent>
                <MjmlColumn>
                    <MjmlTipTapRichTextBlock data={textBlockStylesBlockData} />
                </MjmlColumn>
            </MjmlSection>
        );
    },
...
export const WithListVariants: Story = {
    ...
    render: () => {
        ...
        return (
            <MjmlSection indent>
                <MjmlColumn>
                    <MjmlTipTapRichTextBlock data={listVariantsBlockData} />
                </MjmlColumn>
            </MjmlSection>
        );
    },
...
export const WithInlineStyle: Story = {
    render: () => {
        ...
        return (
            <MjmlSection indent>
                <MjmlColumn>
                    <MjmlTipTapRichTextBlock data={inlineStyleBlockData} />
                </MjmlColumn>
            </MjmlSection>
        );
    },
